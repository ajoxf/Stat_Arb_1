# -*- coding: utf-8 -*-
"""
Created on Tue Jun 10 18:19:45 2025
...
df = yf.download('AUDCAD=X', start='2023-01-01', end='2025-06-01', interval="1d")
...
plt.subplot(2, 1, 1)
plt.plot(df.index, df['Close'], label='AUDCAD Close', alpha=0.7)
...
plt.title('AUDCAD with Bollinger Bands')
plt.legend()
...
plt.title('AUDCAD Trading Strategy vs Buy & Hold - Cumulative Returns')
plt.legend()
plt.grid(True, alpha=0.3)
